...
/**
 * Class that manages the necessary set of actions
 * for the gui.
 *
...
public class ActionManager {
   ...
   public void setNewFileAction(ActionImpl actionImpl) {
      _newFile = new SimpleAction("Nieuw", Settings.getIcon(Settings.NEW_FILE_ICON), actionImpl);
   }
   ...
   public void setSaveFileAction(ActionImpl actionImpl) {
      _saveFile = new SimpleAction("Opslaan", Settings.getIcon(Settings.SAVE_FILE_ICON), actionImpl);
   }
   ...
   public void setOpenFileAction(ActionImpl actionImpl) {
      _openFile = new SimpleAction("Open", Settings.getIcon(Settings.OPEN_FILE_ICON), actionImpl);
   }
   ...
   public void setPrecompileAction(ActionImpl actionImpl) {
      _precompile = new SimpleAction("Voorvertalen", Settings.getIcon(Settings.PRECOMPILE_ICON), actionImpl);
   }
   ...
   public void setCompileAction(ActionImpl actionImpl) {
      _compile = new SimpleAction("Vertalen", Settings.getIcon(Settings.COMPILE_ICON), actionImpl);
   }
   ...
   public void setContinueAction(ActionImpl actionImpl) {
      _continue = new SimpleAction("Starten/doorgaan", Settings.getIcon(Settings.RUN_CONTINUE_ICON), actionImpl);
   }
   ...
   public void setStepAction(ActionImpl actionImpl) {
      _step = new SimpleAction("Stap", Settings.getIcon(Settings.STEP_ICON), actionImpl);
   }
   ...
   public void setStopAction(ActionImpl actionImpl) {
      _stop = new SimpleAction("Stop", Settings.getIcon(Settings.STOP_ICON), actionImpl);
   }
   ...
   public void setResetAction(ActionImpl actionImpl) {
      _reset = new SimpleAction("Reset", Settings.getIcon(Settings.LOAD_ICON), actionImpl);
   }
   ...
   public void setInternalMachineAction(ActionImpl actionImpl) {
      _internalMachine = new SimpleAction("Interne machine", Settings.getIcon(Settings.INTERNAL_MACHINE_ICON), actionImpl);
   }

   public Action getInternalMachineAction() {
      if (_internalMachine == null) {
         setInternalMachineAction(new DummyActionImpl("internal machine action"));
      }
   ...
   public void setCpuAction(ActionImpl actionImpl) {
      _cpu = new SimpleAction("CVO", Settings.getIcon(Settings.CPU_ICON), actionImpl);
   }
   ...
   public void setBuildMachineAction(ActionImpl actionImpl) {
      _buildMachine = new SimpleAction("Bouw machine", Settings.getIcon(Settings.BUILD_MACHINE_ICON), actionImpl);
   ...
   public Action getSimpleComplexityAction() {
      if (_simpleComplexity == null) {
         setSimpleComplexityAction(new DummyActionImpl("simple complexity action"));
      }
   ...
   public Action getComplexComplexityAction() {
      if (_complexComplexity == null) {
         setComplexComplexityAction(new DummyActionImpl("complex complexity action"));
      }
   ...
   public void setAboutAction(ActionImpl actionImpl) {
      _about = new SimpleAction("About", actionImpl);
   }
   ...
   public Action getCompileStatisticsAction() {
      if (_compileStatistics == null) {
         setCompileStatisticsAction(new DummyActionImpl("compile statistics action"));
      }
   ...
   public Action getInputFromScreenAction() {
      if (_inputFromScreen == null) {
         setInputFromScreenAction(new DummyActionImpl("input from screen action"));
      }
   ...
   public Action getOutputToScreenAction() {
      if (_outputToScreen == null) {
         setOutputToScreenAction(new DummyActionImpl("output to screen action"));
      }
   ...
   public Action getCloseExecuteFrameAction() {
      if (_closeExecuteFrame == null) {
         setCloseExecuteFrameAction(new DummyActionImpl("close execute frame action"));
      }
   ...
   public void setShowExecuteFrameAction(ActionImpl actionImpl) {
      _showExecuteFrame = new SimpleAction("Uitvoeringsvenster", Settings.getIcon(Settings.EXECUTE_ICON), actionImpl);
   }

   public Action getShowExecuteFrameAction() {
      if (_showExecuteFrame == null) {
         setShowExecuteFrameAction(new DummyActionImpl("show execute frame action"));
      }
   ...
   private static class DummyActionImpl
