...
public class DynamicTable extends JPanel {
	...
	private class MemoryTableModel extends AbstractTableModel {
		...
		private ArrayList<AbstractMap.SimpleEntry<String, Integer>> labelRows = new ArrayList<AbstractMap.SimpleEntry<String, Integer>>();
		private long[] memory;
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (!parseSucceeded) {
				...
				try {
					...
					int tmpV = Integer.parseInt(splitParse[1]);
					secondValue = tmpV;
				} catch (Exception e) {
