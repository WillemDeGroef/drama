...
public class ExecutionManager
    ...
    private ActionImpl _inputAction;
    ...
    private void addContinueAction() {
        _main.getActionManager().setContinueAction(new ActionImpl() {
            public void react() {
                _guiController.cont();
            }
        });
    ...
    private void addStepAction() {
        _main.getActionManager().setStepAction(new ActionImpl() {
            public void react() {
                _guiController.step();
            }
        });
    ...
    private void addStopAction() {
        _main.getActionManager().setStopAction(new ActionImpl() {
            public void react() {
                _guiController.halt();
            }
        });
    ...
    private void addResetAction() {
        _main.getActionManager().setResetAction(new ActionImpl() {
            public void react() {
    ...
    private void addClearAction() {
        _main.getActionManager().setClearFrameAction(new ActionImpl() {
            public void react() {
    ...
    private void addInternalMachineAction() {
        _main.getActionManager().setInternalMachineAction(new ActionImpl() {
            public void react() {
    ...
    private void addCpuAction() {
        _main.getActionManager().setCpuAction(new ActionImpl() {
            public void react() {
    ...
    private void addSimpleComplexityAction() {
        _main.getActionManager().setSimpleComplexityAction(new ActionImpl() {
            public void react() {
                _guiController.setNiveau(1);
                _main.getActionManager().getSimpleComplexityAction()
                        .setEnabled(false);
                _main.getActionManager().getComplexComplexityAction()
                        .setEnabled(true);
            }
        });
    }
    ...
    private void addComplexComplexityAction() {
        _main.getActionManager().setComplexComplexityAction(new ActionImpl() {
            public void react() {
    ...
    private void addInputFromScreenAction() {
        _main.getActionManager().setInputFromScreenAction(new ActionImpl() {
            public void react() {
                _guiController.resetInputStream();
                _main.getActionManager().getInputFromScreenAction()
                        .setEnabled(false);
                _main.getActionManager().getInputFromFileAction()
                        .setEnabled(true);
    ...
    private void addInputFromFileAction() {
        _main.getActionManager().setInputFromFileAction(new ActionImpl() {
            public void react() {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION)
                    try {
                        ...
                        _main.getActionManager().getInputFromFileAction()
                                .setEnabled(false);
                        _main.getExecuteFrame().statusMessage(
                                file.toString().concat(
                                        " ingesteld als invoerbestand."));
                    } catch (Exception e) {
                    }
            }
        });
    ...
    private void addOutputToScreenAction() {
        _main.getActionManager().setOutputToScreenAction(new ActionImpl() {
            public void react() {
                _guiController.resetOutputStream();
                _main.getActionManager().getOutputToScreenAction()
                        .setEnabled(false);
                _main.getActionManager().getOutputToFileAction()
                        .setEnabled(true);
    ...
    private void addOutputToFileAction() {
        _main.getActionManager().setOutputToFileAction(new ActionImpl() {
            public void react() {
                JFileChooser chooser = new JFileChooser();
                chooser.setCurrentDirectory(Settings.CURRENT_DIRECTORY);
                ExtensionFileFilter filter = new ExtensionFileFilter();
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION)
                    try {
                        File file = FileUtils.ensureExtension(
    ...
    private JPanel createInputPanel() {
        ...
        _inputAction = actionImpl;

        panel.add(textField);

        InputRequestEventManager.addListener(new InputRequestListener() {
