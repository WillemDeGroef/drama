...
public class ExecuteFrame
    ...
    public void setExecutionState(ExecutionState state) {
        ...
        _actionManager.getContinueAction().putValue(SimpleAction.SHORT_DESCRIPTION, state.isStarted() ? "Doorgaan" : "Starten");
    ...
    private JScrollPane createStatusWindow() {
        ...
        return new JScrollPane(_statusWindow, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }
