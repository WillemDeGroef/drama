/**
 *
 * CVS: $Header: /export/home0/cvsroot/socsg/DRAMA/Sources/be/ac/kuleuven/cs/drama/simulator/simple/decoders/VERDecoder.java,v 1.1.1.1 2001/09/07 09:41:38 dirkw Exp $
 *
 * (C) 2000
...
// Source File Name:   VERDecoder.java
...
public class VERDecoder extends MathDecoder {
   ...
   protected BigInteger operate(BigInteger biginteger, BigInteger biginteger1) {
	...
	protected boolean hasOverflow(long registerValue, long operand, long result) {
		return result < -5000000000L || result > 4999999999L || (operand != 0 && result / operand != registerValue);
	}
