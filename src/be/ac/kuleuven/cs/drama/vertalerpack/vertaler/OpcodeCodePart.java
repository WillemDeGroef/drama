...
public abstract class OpcodeCodePart extends LetterCodePart {
    ...
    public int convertRegister() throws AbnormalTerminationException {
    ...
    private static final Map<String, Integer> _registers = new HashMap<String, Integer>();
    ...
    public int convertModeType() throws AbnormalTerminationException {
        switch (getModeType()) {
