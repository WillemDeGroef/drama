...
public class VariableTable {
     ...
     *               parent the table to query if this one does not define a key, null if none
     */
    public VariableTable(List<String> keys, List values, VariableTable parent) {
        this(parent);

        for (int i = 0; i < keys.size(); i++) {
            putPrimitive(keys.get(i), (String) values.get(i));
        }
