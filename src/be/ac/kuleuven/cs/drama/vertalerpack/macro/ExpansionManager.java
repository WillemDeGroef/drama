...
public class ExpansionManager {
    ...
    private final Map<String, MacroDefinition> _macroDefinitions;
    ...
    private ArrayList<Integer> _linelist = new ArrayList<>();
    ...
    public ArrayList<Integer> getLineMap() {
    ...
    public MacroDefinition getMacroDefinition(String name) {
        return this._macroDefinitions.get(name);
    }
